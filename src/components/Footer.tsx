        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="footer__copyright__text"><p>
                    Copyright ©<script type="text/javascript" src="https://www.google-analytics.com/analytics.js"></script><script>document.write(new Date().getFullYear());</script>All rights reserved | This template is made with <i className="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"><span className='colo'>Colorlib</span></a>
                </p></div>
