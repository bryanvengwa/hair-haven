...
import thebig from '../../public/images/blog.jpg'
...
function ShoppingDetails() {
  return (
    ...
    <Image className="product__details__pic__item--large" src={thebig} alt='Logo' />
    </div>
    ...
    <div className="owl-stage-outer">
      <div className="owl-stage" >
        ...
        <Image className="product__details__pic__item--large" src={thebig} alt='Logo' />
            </div><div className="owl-item cloned">
            <Image src={thebig} alt='Logo' />
                </div>
                <div className="owl-item cloned" >
                <Image src={thebig} alt='Logo' />
                    </div><div className="owl-item cloned">
                    <Image src={thebig} alt='Logo' />
                        ...
                        <div className="owl-item"><Image src={thebig} alt='Logo' />
                          </div>
                          ...
                          <Image src={thebig} alt='Logo' />
                              ...
                              <Image src={thebig} alt='Logo' />
                                  ...
                                  <Image src={thebig} alt='Logo' />
                                      </div><div className="owl-item cloned active">
                                      <Image src={thebig} alt='Logo' />
                                          </div><div className="owl-item cloned active">
                                          <Image src={thebig} alt='Logo' />
                                              </div><div className="owl-item cloned active">
